...
The following describes how to configure a down-party OpenID Connect Relaying Party (RP) / client in a parallel FoxIDs track and create a trust relation ship to your FoxIDs track. By configuring the parallel FoxIDs track as an up-party OpenID Provider (OP) / authority in your FoxIDs track.

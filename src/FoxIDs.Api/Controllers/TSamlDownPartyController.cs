...
namespace FoxIDs.Controllers
{
    ...
    /// Saml down party api.
    /// </summary>
    public class TSamlDownPartyController : TenantPartyApiController<Api.SamlDownParty, SamlDownParty>
    {
        private readonly ValidateSamlPartyLogic validateSamlPartyLogic;

        public TSamlDownPartyController(TelemetryScopedLogger logger, IMapper mapper, ITenantRepository tenantService, ValidatePartyLogic validatePartyLogic, ValidateSamlPartyLogic validateSamlPartyLogic) : base(logger, mapper, tenantService, validatePartyLogic)
        {

...
namespace FoxIDs.Controllers
{
    ...
    {
        public TOidcClientSecretDownPartyController(TelemetryScopedLogger logger, IMapper mapper, ITenantDataRepository tenantDataRepository, SecretHashLogic secretHashLogic) : base(logger, mapper, tenantDataRepository, secretHashLogic)
        { }

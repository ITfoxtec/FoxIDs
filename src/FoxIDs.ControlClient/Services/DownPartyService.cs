...
namespace FoxIDs.Client.Services
{
    public class DownPartyService : BaseService
    {
        ...
        public async Task<List<OAuthClientSecretResponse>> GetOidcClientSecretDownPartyAsync(string name) => await GetAsync<List<OAuthClientSecretResponse>>(oauthclientsecretApiUri, name, parmName: "partyname");
        ...
        public async Task<List<OAuthClientSecretResponse>> GetOAuthClientSecretDownPartyAsync(string name) => await GetAsync<List<OAuthClientSecretResponse>>(oauthclientsecretApiUri, name, parmName: "partyname");

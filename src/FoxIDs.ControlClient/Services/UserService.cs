...
namespace FoxIDs.Client.Services
{
    public class UserService : BaseService
    {
        ...
        public async Task<PaginationResponse<RefreshTokenGrant>> GetRefreshTokenGrantsAsync(string filterUserIdentifier, string filterSub, string filterClientId, string filterUpPartyName, string paginationToken = null) => await GetListAsync<RefreshTokenGrant>(refreshTokenGrantsApiUri, filterUserIdentifier, filterSub, filterClientId, filterUpPartyName, parmName1: nameof(filterUserIdentifier), parmName2: nameof(filterSub), parmName3: nameof(filterClientId), parmName4: nameof(filterUpPartyName), paginationToken: paginationToken);
        ...
        public async Task DeleteRefreshTokenGrantsAsync(string userIdentifier = null, string sub = null, string clientId = null, string upPartyName = null) => await DeleteAsync(refreshTokenGrantsApiUri, userIdentifier, sub, clientId, upPartyName, parmName1: nameof(userIdentifier), parmName2: nameof(sub), parmName3: nameof(clientId), parmName4: nameof(upPartyName));

        public async Task<PaginationResponse<ActiveSession>> GetActiveSessionsAsync(string filterUserIdentifier, string filterSub, string filterUpPartyName, string filterDownPartyName, string filterSessionId, string paginationToken = null) => await GetListAsync<ActiveSession>(activeSessionsApiUri, filterUserIdentifier, filterSub, filterUpPartyName, filterDownPartyName, filterSessionId, parmName1: nameof(filterUserIdentifier), parmName2: nameof(filterSub), parmName3: nameof(filterUpPartyName), parmName4: nameof(filterDownPartyName), parmName5: nameof(filterSessionId), paginationToken: paginationToken);
        public async Task DeleteActiveSessionsAsync(string userIdentifier = null, string sub = null, string upPartyName = null, string downPartyName = null, string sessionId = null) => await DeleteAsync(activeSessionsApiUri, userIdentifier, sub, upPartyName, downPartyName, sessionId, parmName1: nameof(userIdentifier), parmName2: nameof(sub), parmName3: nameof(upPartyName), parmName4: nameof(downPartyName), parmName5: nameof(sessionId));
    }
}

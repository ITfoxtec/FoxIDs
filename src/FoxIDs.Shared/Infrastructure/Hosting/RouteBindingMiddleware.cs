            ...
            try
            {
                ...
                if (await PreAsync(httpContext, route))
                {
                    ...
                    if (trackIdKey != null)
                    {
                        ...
                        scopedLogger.SetScopeProperty(Constants.Logs.TenantName, routeBinding.TenantName);
                        scopedLogger.SetScopeProperty(Constants.Logs.TrackName, routeBinding.TrackName);
                    }

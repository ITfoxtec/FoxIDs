...
namespace FoxIDs.Logic
{
    public class TrackCacheLogic : LogicBase
    {
        ...
        public TrackCacheLogic(Settings settings, IDataCacheProvider cacheProvider, ITenantRepository tenantRepository, IHttpContextAccessor httpContextAccessor) : base(httpContextAccessor)
        {

...
namespace FoxIDs.Logic
{
    public class UpPartyCacheLogic : LogicBase
    {
        ...
        public UpPartyCacheLogic(Settings settings, IDataCacheProvider cacheProvider, ITenantRepository tenantRepository, IHttpContextAccessor httpContextAccessor) : base(httpContextAccessor)
        {

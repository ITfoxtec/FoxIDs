...
namespace FoxIDs.Repository
{
    public abstract class MasterDataRepositoryBase : IMasterDataRepository
    {
        ...
        public abstract ValueTask<int> CountAsync<T>(Expression<Func<T, bool>> whereQuery = null) where T : MasterDocument;
        public abstract ValueTask<T> GetAsync<T>(string id, bool required = true) where T : MasterDocument;
        public abstract ValueTask<HashSet<T>> GetListAsync<T>(Expression<Func<T, bool>> whereQuery = null, int maxItemCount = 50) where T : MasterDocument;
        ...
        public abstract ValueTask<T> DeleteAsync<T>(string id) where T : MasterDocument;

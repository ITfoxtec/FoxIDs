...
namespace FoxIDs.Controllers
{
    ...
    public class LoginController : EndpointController
    {
        ...
        {
            return new UpPartyLink { Name = upParty.Name, Type = upParty.Type, Issuers = upParty.Issuers, HrdDomains = upParty.HrdDomains, HrdShowButtonWithDomain = upParty.HrdShowButtonWithDomain, HrdDisplayName = upParty.HrdDisplayName, HrdLogoUrl = upParty.HrdLogoUrl };
        }

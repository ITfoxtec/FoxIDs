...
namespace FoxIDs.Logic
{
    public class TrackLinkRpInitiatedLogoutDownLogic : LogicSequenceBase
    {
        ...
        public async Task<IActionResult> LogoutResponseAsync(string partyId)
        {
            ...
            return HttpContext.GetTrackUpPartyUrl(party.ToUpTrackName, party.ToUpPartyName, Constants.Routes.TrackLinkController, Constants.Endpoints.TrackLinkLogoutUpResponse, includeKeySequence: true).ToRedirectResult();
        }
    }
}

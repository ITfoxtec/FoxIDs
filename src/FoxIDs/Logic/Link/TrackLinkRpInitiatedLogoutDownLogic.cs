...
namespace FoxIDs.Logic
{
    public class TrackLinkRpInitiatedLogoutDownLogic : LogicSequenceBase
    {
        ...
        public TrackLinkRpInitiatedLogoutDownLogic(TelemetryScopedLogger logger, IServiceProvider serviceProvider, ITenantDataRepository tenantRepository, SequenceLogic sequenceLogic, HrdLogic hrdLogic, IHttpContextAccessor httpContextAccessor) : base(httpContextAccessor)
        {
            this.logger = logger;

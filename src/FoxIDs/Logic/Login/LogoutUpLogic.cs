...
namespace FoxIDs.Logic
{
    public class LogoutUpLogic : LogicSequenceBase
    {
        ...
        public LogoutUpLogic(TelemetryScopedLogger logger, IServiceProvider serviceProvider, SequenceLogic sequenceLogic, AuditLogic auditLogic, IHttpContextAccessor httpContextAccessor) : base(httpContextAccessor)
        {
            this.logger = logger;
        ...
        public async Task<IActionResult> LogoutResponseAsync(LoginUpSequenceData sequenceData)
        {
            ...
            auditLogic.LogLogoutEvent(PartyTypes.Login, sequenceData.UpPartyId, sequenceData.SessionId);
